...
/**
 * A formula is a value and therefore inherits all methods from the Value class. This class is
 * responsible for processing the operation the user intends to process.
 */
